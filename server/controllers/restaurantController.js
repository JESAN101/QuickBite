...
// ==========================================
const updateMyOrderStatus = asyncHandler(async (req, res) => {
...
const createMyFood = asyncHandler(async (req, res) => {
  const { name, description, price, categories, preparationTime, isAvailable } =
    req.body;
...
const updateMyFood = asyncHandler(async (req, res) => {
  ...
  if (food.restaurant.toString() !== req.restaurant._id.toString()) {
    throw new ErrorResponse(
